  ...
  const renderPrivateStep2 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Salarié du Privé - Étape 2/6</p>
      </div>
  ...
  const renderPrivateStep3 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Salarié du Privé - Étape 3/6</p>
      </div>
  ...
  const renderPrivateStep5 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Salarié du Privé - Étape 5/6</p>
      </div>
  ...
  const renderPrivateStep6 = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Salarié du Privé - Étape 6/6</p>
      </div>
