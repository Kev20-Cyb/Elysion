        ...
        <div className='flex-1 flex items-center justify-center p-8'>
          <div className='max-w-md w-full'>
            ...
            <div className='card-elysion fade-in'>
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <div>
                  <label
                    htmlFor='email'
                    className='block text-sm font-medium text-elysion-text-dark mb-2'
                  >
                    Email
                  </label>
                  <input
                ...
                <div>
                  <div className='flex justify-between items-center mb-2'>
                    <label
                      htmlFor='password'
                      className='block text-sm font-medium text-elysion-text-dark'
                    >
                      Mot de passe
                    </label>
                    <button
            ...
            <div className='mt-8 text-center text-sm text-elysion-text-light'>
              <p>
                🔒 Vos données sont chiffrées et stockées en France conformément
                au RGPD
              </p>
            </div>
          </div>
